...
def disable_cloudfront_distributions():
    ...
    logger.info("[1/5] Disabling CloudFront distributions")
...
def delete_cloudfront_distributions():
    ...
    logger.info("[5/5] Deleting CloudFront distributions")
...
def delete_knowledge_bases():
    ...
    logger.info("[2/5] Deleting Knowledge Bases")
...
def delete_s3_buckets():
    ...
    logger.info("[4/5] Deleting S3 buckets")
...
def delete_opensearch_collection():
    ...
    logger.info("[2/5] Deleting OpenSearch collection")
...
def delete_agentcore_websearch_gateway(skip_confirmation: bool = False) -> bool:
    ...
    """
    logger.info("[3/5] Deleting AgentCore Web Search gateway")
...
def delete_iam_roles(
    ...
    logger.info("[4/5] Deleting IAM roles")
