...
# Configuration
project_name = "narae-project"  # at least 3 characters
region = "us-west-2"
...
def create_opensearch_collection(knowledge_base_role_arn: str = None) -> Dict[str, str]:
    ...
    logger.info("[3/5] Creating OpenSearch Serverless collection")
...
def create_knowledge_base_with_opensearch(opensearch_info: Dict[str, str], knowledge_base_role_arn: str, s3_bucket_name: str) -> str:
    ...
    logger.info("[4/5] Creating Knowledge Base with OpenSearch collection")
...
def create_agentcore_memory_role() -> str:
    ...
    logger.info("[2/5] Creating AgentCore Memory IAM role")
